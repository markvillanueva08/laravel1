@include('partials.header')
    ...
    <main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2xl">
            <section>
                ...
                <p class="text-gray-600 pt-2">Register new Account <a href="/register" class="text-purple-300 font-bold">here</a></p>
            </section>
            <section class="mt-10">
                <x-messages/>
                <form action="/login/process" method="POST" class="flex flex-col">
                    ...
                    <button class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 rounded shadow-lg hover:shadow-xl transtion duration-200" type="submit">Login</button>
                </form>
            </section>
    </main>
